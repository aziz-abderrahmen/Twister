...
function Signup() {
    ...
    const uploadPic = () => {
        ...
        data.append('upload_preset', "twister_user")
        data.append('cloud_name', "abderrahmen11")
        fetch("https://api.cloudinary.com/v1_1/abderrahmen11/image/upload", {
            method: "post",
            body: data
        })
            .then(res => res.json())
